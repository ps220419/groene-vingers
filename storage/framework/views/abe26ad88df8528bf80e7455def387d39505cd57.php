...
} elseif ($_instance->childHasBeenRendered('5bBMe7R')) {
    $componentId = $_instance->getRenderedChildComponentId('5bBMe7R');
    $componentTag = $_instance->getRenderedChildComponentTagName('5bBMe7R');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('5bBMe7R');
} else {
    $response = \Livewire\Livewire::mount('cartcounter', []);
    $html = $response->html();
    $_instance->logRenderedChild('5bBMe7R', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('CdZgcW9')) {
    $componentId = $_instance->getRenderedChildComponentId('CdZgcW9');
    $componentTag = $_instance->getRenderedChildComponentTagName('CdZgcW9');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('CdZgcW9');
} else {
    $response = \Livewire\Livewire::mount('admin.groothandel.myordercounter', []);
    $html = $response->html();
    $_instance->logRenderedChild('CdZgcW9', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php /**PATH C:\school\leerjaar 3\Project 6\Projact6\GV-site\resources\views/components/header.blade.php ENDPATH**/ ?>